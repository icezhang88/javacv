...
public abstract class GrabberTmplate {
	 ...
	 */
	protected AVFormatContext openInput(String url) {
		AVFormatContext pFormatCtx = new AVFormatContext(null);
		if(avformat_open_input(pFormatCtx, url, null, null)==0) {
			return pFormatCtx;
		}
		throw new CommonRollbackException("Didn't open video file");
	}
	 ...
	 * @return
	 */
	protected AVFormatContext findStreamInfo(AVFormatContext pFormatCtx)  {
		if (avformat_find_stream_info(pFormatCtx, (PointerPointer<?>)null)>= 0) {
			return pFormatCtx;
		}
		throw new CommonRollbackException("Didn't retrieve stream information");
	}
	 ...
	 * @return
	 */
	protected AVCodecContext findVideoStream(AVFormatContext pFormatCtx ,int videoStream)  {
		if(videoStream >=0) {
