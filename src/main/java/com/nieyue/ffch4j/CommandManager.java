package com.nieyue.ffch4j;

import com.nieyue.ffch4j.commandbuidler.CommandAssembly;
import com.nieyue.ffch4j.commandbuidler.CommandBuidler;
import com.nieyue.ffch4j.config.ProgramConfig;
import com.nieyue.ffch4j.data.CommandTasker;
import com.nieyue.ffch4j.data.TaskDao;
import com.nieyue.ffch4j.handler.TaskHandler;
import com.nieyue.ffch4j.config.ProgramConfig;

import java.util.Collection;
import java.util.Map;

import static com.nieyue.ffch4j.util.PropertiesUtil.load;
import static com.nieyue.ffch4j.util.PropertiesUtil.load;
